...
- **Property queries.** `find_nodes` and `find_nodes_paged` do equality queries. `find_nodes_range` and `find_nodes_range_paged` do numeric range queries with exact bound and cursor semantics.
