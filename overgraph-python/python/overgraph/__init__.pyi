...
class PyPropertyRangePageResult:
    items: IdArray
    next_cursor: PyPropertyRangeCursor | None
    def __len__(self) -> int: ...
    def __bool__(self) -> bool: ...
    def __repr__(self) -> str: ...
...
class OverGraph:
    ...
    def begin_write_txn(self) -> PyWriteTxn: ...
    ...
    def find_nodes_range(self, type_id: int, prop_key: str, lower: PyPropertyRangeBound | None = None, upper: PyPropertyRangeBound | None = None) -> IdArray: ...
    ...
    def find_nodes_range_paged(self, type_id: int, prop_key: str, lower: PyPropertyRangeBound | None = None, upper: PyPropertyRangeBound | None = None, *, limit: int | None = None, after: PyPropertyRangeCursor | None = None) -> PyPropertyRangePageResult: ...
    def neighbors_paged(
        self,
        node_id: int,
        *,
...
class PyWriteTxn:
    ...
    def get_node_by_key(self, type_id: int, key: str) -> dict[str, Any] | None: ...
    ...
    def commit(self) -> PyTxnCommitResult: ...
...
class AsyncOverGraph:
    ...
    async def find_nodes_range(self, type_id: int, prop_key: str, lower: PyPropertyRangeBound | None = None, upper: PyPropertyRangeBound | None = None) -> IdArray: ...
    ...
    async def find_nodes_range_paged(self, type_id: int, prop_key: str, lower: PyPropertyRangeBound | None = None, upper: PyPropertyRangeBound | None = None, *, limit: int | None = None, after: PyPropertyRangeCursor | None = None) -> PyPropertyRangePageResult: ...
...
class AsyncWriteTxn:
    async def upsert_node(self, type_id: int, key: str, *, props: dict[str, Any] | None = None, weight: float = 1.0, dense_vector: list[float] | None = None, sparse_vector: list[tuple[int, float]] | None = None) -> dict[str, Any]: ...
    async def upsert_node_as(self, alias: str, type_id: int, key: str, *, props: dict[str, Any] | None = None, weight: float = 1.0, dense_vector: list[float] | None = None, sparse_vector: list[tuple[int, float]] | None = None) -> dict[str, Any]: ...
    async def upsert_edge(self, from_ref: dict[str, Any], to_ref: dict[str, Any], type_id: int, *, props: dict[str, Any] | None = None, weight: float = 1.0, valid_from: int | None = None, valid_to: int | None = None) -> dict[str, Any]: ...
    async def upsert_edge_as(self, alias: str, from_ref: dict[str, Any], to_ref: dict[str, Any], type_id: int, *, props: dict[str, Any] | None = None, weight: float = 1.0, valid_from: int | None = None, valid_to: int | None = None) -> dict[str, Any]: ...
    ...
    async def get_edge_by_triple(self, from_ref: dict[str, Any], to_ref: dict[str, Any], type_id: int) -> dict[str, Any] | None: ...
